...
router.post('/', async (req, res) => {
  try {
    ...
    <div class="flex h-full shadow-md pt-2 md:pt-4 px-2 md:px-6 leading-3 bg-slate-100 rounded-lg overflow-auto no-scrollbar">
      <div id="right-panel-details" class="w-full">
        <section id="thread">

          <div id="mainPost" class="border-b-2 border-blue-300">
            <div id="postContentHeader">
              ...
              <div class="flex justify-between items-center mb-2">
                ...
                <div>
                  ...
                  class="del-btn flex align-middle px-2 bg-black text-blue-400 uppercase rounded shadow-md hover:bg-blue-400 hover:text-slate-900 hover:shadow-lg active:outline-none active:ring-0 active:bg-slate-800 active:shadow-lg transition duration-150 ease-in-out">
            ...
            <div id="postContentFooter" class="flex pt-2 md:pt-5 pb-2 md:pb-5">
              ...
              {{else}}
                <a href="/login">
                <button type="button" data-postid={{mainPostContent.threadID}} 
                  class="shrink-0 rounded-full p-1 mx-2 shadow-lg bg-blue-300 hover:bg-blue-400 active:shadow-none">                                       
                  <span class="pointer-events-none">
                    <img src="/images/reply_FILL0_wght400_GRAD0_opsz48.svg"
                    class="rounded-full w-3 md:w-5 pointer-events-none" alt="Reply">
                  </span>                                 
              ...
              <div class="flex">
                <button id="quote-btn" type="button" data-postid={{mainPostContent.threadID}}
          ...
          {{#each posts}}  
          <div id="postReply" class="my-3 border-b-2 pb-2 border-blue-300">
            <div class="flex items-center">
              <span class="shrink-0"><img src="https://mdbcdn.b-cdn.net/img/new/avatars/8.webp" 
                class="rounded-full w-8 md:w10" alt="Avatar">
              </span>
  ...
  `);
    ...
    const threadContentHTML = mainContentTemplate(
      {
